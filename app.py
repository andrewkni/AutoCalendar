...
def schedule(tasks, conflicts, start_date, end_date, start_time, end_time):
    ...
    # Compute available times outside of conflicts
...
def main():
    ...
    with st.form("add_event"):
        ...
        duration = st.time_input("Duration of task", value=dt.time(0, 0))
    ...
    with st.form("add_conflict"):
        ...
        # default duration is 0
        duration = st.time_input("Duration of conflict", value=dt.time(0, 0))
